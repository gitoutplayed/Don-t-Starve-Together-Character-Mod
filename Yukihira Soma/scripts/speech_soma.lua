...
return {
	...
	DESCRIBE =
	{
		...
		BERRIES_COOKED = "Maybe I can try them with squid next time.",
		BERRYBUSH =
		{
		...
		BIRD_EGG = "Maybe i can cook this",
		BIRD_EGG_COOKED = "The secert to every morning",
		...
		CACTUS =
		{
			...
			PICKED = "Worth the pain",
		},
		CACTUS_MEAT_COOKED = "Grilled fruit of the desert.",
		CACTUS_MEAT = "The tasty meal from the desert",
